...
namespace ClinicService.Controllers
{
    ...
    public class ConsultationController : ControllerBase
    {
        ...
        {
            if (updateConsultRequest.ConsultationId == 0 ||
                updateConsultRequest.ClientId == 0 ||
                updateConsultRequest.PetId == 0 ||
                string.IsNullOrEmpty(updateConsultRequest.Description) ||
                updateConsultRequest.ConsultationDate.Equals(null))
            {
