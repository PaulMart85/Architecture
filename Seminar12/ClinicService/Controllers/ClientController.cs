...
namespace ClinicService.Controllers
{
    ...
    public class ClientController : ControllerBase
    {
        ...
        {
            if (string.IsNullOrEmpty(createClientRequest.FirstName) ||
                string.IsNullOrEmpty(createClientRequest.SurName) ||
                string.IsNullOrEmpty(createClientRequest.Document))
            {
